        ...
        <form >
          ...
          <div className="w-full md:w-full lg:w-full space-y-4 md:space-y-4 lg:space-y-6 mb-8 md:mb-8 lg:mb-10">
            <div className="flex px-3 py-1 md:py-0 md:px-4 lg:px-6 items-center md:items-center gap-2 md:gap-3 lg:gap-4 w-full md:w-full lg:w-[362px]  md:h-[30px] lg:h-[40px] border border-[#0D2FA5] rounded-full">
              <FaUser className="text-[#0D2FA5] lg:size-5" />
              <input
                type="text"
                name="name"
            ...
            <div className="border border-[#0D2FA5] rounded-full  pl-5 px-1 py-1 md:px-1 md:pl-5 md:py-1 lg:py-1 lg:px-1 lg:pl-5 lg:w-48 flex"><input type="text" value={otp} onChange={(e)=>setOtp(e.target.value)} name="otp" id="otp" className=" outline-none w-20 md:w-24 lg:w-20 " placeholder="Enter OTP" />
